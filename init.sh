...
echo -e "\n===========================\n\n  YOU CAN NOW LOG IN TO MATTERMOST AT $MM_URL\n\n        username:  $user_name\n        password:  $user_password\n\n  MAKE AND DEPLOY THE PLUGIN IN THE TERINAL WITH COMMAND:\n\n >  MM_SERVICESETTINGS_SITEURL=http://localhost:8065 MM_ADMIN_USERNAME=$user_name MM_ADMIN_PASSWORD=$user_password make deploy\n\n  THEN ENABLE THE PLUGIN & CONFIGURE YOUR API KEY: $MM_URL/admin_console/plugins/plugin_summarize"

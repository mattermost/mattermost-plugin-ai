...
MM_SERVICESETTINGS_ENABLEDEVELOPER=true MM_DEBUG=true MM_SERVICESETTINGS_SITEURL=http://localhost:8065 MM_ADMIN_USERNAME=$user_name MM_ADMIN_PASSWORD=$user_password make deploy

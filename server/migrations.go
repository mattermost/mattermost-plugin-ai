...
func MigrateServicesToBots(API cluster.MutexPluginAPI, pluginAPI *pluginapi.Client, cfg agents.Config) (agents.Config, error) {
	mtx, err := cluster.NewMutex(API, "migrate_services_to_bots")
	if err != nil {
